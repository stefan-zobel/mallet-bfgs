 ...
 */
public final class ConjugateGradient implements Optimizer {
    private static final Logger logger = Logger
            .getLogger(ConjugateGradient.class.getName());
    ...
    public boolean optimize(int numIterations) {
        ...
        for (int iterationCount = 0; iterationCount < numIterations; iterationCount++) {
            ...
            if (twoNorm < gradientTolerance) {
                logger.info("ConjugateGradient converged: gradient two norm "
                        + twoNorm + ", less than " + gradientTolerance);
                converged = true;
                return true;
            }
            ...
            // close to the maximum in that direction. In tests, sometimes the
