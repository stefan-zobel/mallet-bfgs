...
/**
 * Unit Test for class TestOptimizer2.java
 * 
 * @author <a href="mailto:casutton@cs.umass.edu">Charles Sutton</a>
 */
public class TestOptimizer2 extends TestCase {

    public TestOptimizer2(String name) {
        super(name);
    }
    ...
    public static TestSuite suite() {
        return new TestSuite(TestOptimizer2.class);
    }
